...
from mlflowproject.pipeline.stage_02_datavalidation  import DataValidationTrainingPipeline
...
from mlflowproject.pipeline.stage_05_model_evalution import ModelEvaluationTrainingPipeline
